...
public class RobotContainer {
    ...
    public RobotContainer() {
        // Named Commands
        NamedCommands.registerCommand("Shooter Auto", new cmdAuto_AutoShoot(bed, feeder, shooter, intake, 0.70).withTimeout(4.5));
    ...
    public void ConfigureTeleOpControls(){
        ...
        /// Intake Controls
        driverOne.leftTrigger().whileTrue(new cmdIntake_TeleOp(intake, ()->-.4));
        driverOne.rightTrigger().whileTrue(new cmdIntake_TeleOp(intake, ()->.4));
